...
export const AuthBoxInput = (
    { label, text, onInputChange, type }:
        AuthInputProps
) => {
...
export const AuthInput = (
    { text, onInputChange, type }: { text: string; onInputChange: (input: string) => void; type?: string }
) => {
...
export const AuthInputPassword = (
    { text, onInputChange }: { text: string; onInputChange: (input: string) => void }
) => {
