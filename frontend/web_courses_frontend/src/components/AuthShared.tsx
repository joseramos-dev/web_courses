...
export const AuthInput = ({ label, text, onInputChange, type, onChangeVisibility }: AuthInputProps) => (
    <div className="mb-4">
        <label>
            ...
            <div className="relative mt-1">
                ...
                />
                {(onChangeVisibility) && (
                    <div className="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 cursor-pointer" onClick={onChangeVisibility}>
